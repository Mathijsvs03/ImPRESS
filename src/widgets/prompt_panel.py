            ...
            dbc.CardBody([
                ...
                html.Div([
                    ...
                    dbc.Button([
                        ...
                        "Generate Image"
                    ], id="generate-image-button", color="primary", className="w-100")
                ], className="mb-4"),
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Div([
                            ...
                            html.Span("(i)", id="guidance-tooltip-icon", style={"marginLeft": "6px", "cursor": "pointer"})
                        ]),
                        dcc.Slider(
                            id="guidance-slider",
                            min=1,
                        ...
                        dbc.Tooltip(
                            "Controls how much the model rewrites your prompt. The higher the score the more the prompt will be changed.",
                    ...
                    ], id="generate-prompt-button", color="secondary", className="w-100")
                ],
