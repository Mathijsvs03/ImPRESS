    ...
    return dbc.Card([
        dbc.CardBody([
            ...
            dbc.Button([
                ...
                "Generate Keywords"
            ], id="generate-keywords-button", color="primary", disabled=True,
                className="w-100", style={"marginBottom": "10px"}),
            dbc.Button([
                html.Span("✨", style={"marginRight": "5px"}),
                "Generate Prompt from Keywords"
            ], id="generate-prompt-button-keywords", color="primary",
                style={"display": "none"}, className="w-100"),
